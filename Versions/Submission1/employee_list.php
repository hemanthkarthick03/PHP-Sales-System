                    ...
                    <div class="form-group">
                        <select class="form-control" name="employee_name">
                            ...
                            <?php foreach ($employee_names as $name): ?>
                                <option value="<?php echo htmlspecialchars($name); ?>" <?php echo (isset($_GET['employee_name']) && $_GET['employee_name'] == $name) ? 'selected' : ''; ?>><?php echo htmlspecialchars($name); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card">
                        ...
                        <div class="query-btn-container">
                            <a href="query_data.php?employee_id=<?php echo $row['id']; ?>" class="query-btn">View Details</a>
                        </div>
                    </div>
                </div>
            <?php endwhile; ?>
